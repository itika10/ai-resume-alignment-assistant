...
def check_ats_compatibility(resume_data, jd_data, skill_mapping, validation_result, openai_api_key: str):
    chain = get_ats_checker_chain(openai_api_key=openai_api_key)
    return chain.invoke(
        {
